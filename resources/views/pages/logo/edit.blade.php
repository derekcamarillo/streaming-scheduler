            ...
            <div class="row edit-playlist-section">
                <div class="col-xs-7 col-sm-5 col-md-5">
                    <select class="form-control" id="project">
                        @foreach($logo->projects as $project)
        ...
        <div class="col-sm-12 select-box">
            <div class="row edit-playlist-options">
                ...
                <div class="col-xs-6 col-sm-3 col-md-3">
                    ...
                    <input type="text" placeholder="10" class="text-center" value="{{ $logo->xPosition }}">
                </div><!--col-3-->

                <div class="col-xs-6 col-sm-3 col-md-3">
                    <span>Ofset Y-Position</span>
                    <input type="text" placeholder="10" class="text-center" value="{{ $logo->yPosition }}">
                </div><!--col-3-->
